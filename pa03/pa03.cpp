...
int main() {
    ...
    cout << report_title << endl << endl
         << left << setw(6) << "Date"
         << setw(24) << "Homeowner"
         << right << setw(12) << "Sell Price"
         << setw(12) << "Sales Cost"
         << setw(12) << "Due Agency"
         << setw(12) << "Due Agent" << endl
         << setw(78) << setfill('-') << "-" << setfill(' ') << endl;
    // output first item
    cout << right << setw(2) << setfill('0') << sale_date_1
         << left << setw(4) << setfill(' ') << ' '
         << setw(24) << homeowner_name_1
         << right << setw(12) << fixed << setprecision(2) << sell_price_1
         << setw(12) << sales_cost_1
         << setw(12) << agency_cmsn_1
         << setw(12) << agent_cmsn_1 << endl;
    // output second item
    cout << setw(2) << setfill('0') << sale_date_2
         << left << setw(4) << setfill(' ') << ' '
         << setw(24) << homeowner_name_2
         << right << setw(12) << sell_price_2
         << setw(12) << sales_cost_2
         << setw(12) << agency_cmsn_2
         << setw(12) << agent_cmsn_2 << endl;
    // output first item
    cout << setw(2) << setfill('0') << sale_date_3
         << left << setw(4) << setfill(' ') << ' '
         << setw(24) << homeowner_name_3
         << right << setw(12) << sell_price_3
         << setw(12) << sales_cost_3
         << setw(12) << agency_cmsn_3
         << setw(12) << agent_cmsn_3 << endl << endl;
    // output totals
    cout << setw(30) << "TOTALS: "
         << setw(12) << setfill('*') << sell_price_total
         << setw(12) << sales_cost_total
         << setw(12) << agency_cmsn_total
         << setw(12) << agent_cmsn_total << endl;
